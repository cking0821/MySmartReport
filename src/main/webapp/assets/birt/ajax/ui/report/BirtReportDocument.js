...
BirtReportDocument.prototype = Object.extend( new AbstractBaseReportDocument( ),
{
	...
	initialize : function( id, tocElement )
	{
		...
		this.__beh_edit = this.__beh_edit.bind(this);
		...
		birtEventDispatcher.registerEventHandler( birtEvent.__E_EDIT, this.__instance.id, this.__beh_edit );
	...
	__beh_edit : function(id){
		window.open("initReportDataTblEdit?id=" + id);
	},
