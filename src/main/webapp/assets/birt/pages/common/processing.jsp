...
<HTML>
	<HEAD>
		...
		<LINK REL="stylesheet" HREF="<%= request.getContextPath( ) + "/assets/birt/styles/style.css" %>" TYPE="text/css">
	</HEAD>
	<BODY STYLE="background-color: #ECE9D8;">
		<DIV ID="progressBar" ALIGN="center">
			<TABLE WIDTH="250px" CLASS="birtviewer_progresspage" CELLSPACING="10px">
				...
				<TR>
					<TD ALIGN="center">
						<IMG SRC="<%= request.getContextPath( ) + "/assets/birt/images/" + (rtl?"Loading_rtl":"Loading") + ".gif" %>" ALT="Progress Bar Image"/>
					</TD>
				</TR>
			</TABLE>
		</DIV>
