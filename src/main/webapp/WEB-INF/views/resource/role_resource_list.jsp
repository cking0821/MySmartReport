...
<div class="row">
	<div class="col-md-12">
		<form>
			...
			<div class="form-group">
				<button type="button" name="search" onclick="updateResource()" class="btn btn-primary"><i class="fa fa-search">保存</i>
               	</button>
               	
               	<button type="button" name="search" class="btn btn-default"><i class="fa fa-search">关闭</i>
               	</button>
